...
> **Fuente:** AWS DevOps Blog · 2025-11-29
...
1. **Apply the steering rules** in real-world projects, whether brownfield or greenfield. Refer to our [companion AI-DLC workflow walkthrough blog](/blogs/devops/building-with-ai-dlc-using-amazon-q-developer/) for step-by-step instructions on how to build using AI-DLC in Amazon Q Developer.
